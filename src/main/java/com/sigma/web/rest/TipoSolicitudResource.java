...
/**
 * REST controller for managing {@link com.sigma.domain.TipoSolicitud}.
 */
@RestController
@RequestMapping("/api")
public class TipoSolicitudResource {
    ...
    private static final String ENTITY_NAME = "comercialTipoSolicitud";
    ...
    public ResponseEntity<TipoSolicitud> createTipoSolicitud(@Valid @RequestBody TipoSolicitud tipoSolicitud) throws URISyntaxException {
    ...
    public ResponseEntity<TipoSolicitud> updateTipoSolicitud(@Valid @RequestBody TipoSolicitud tipoSolicitud) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, tipoSolicitud.getId().toString()))
            .body(result);
    }
